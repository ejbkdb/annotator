...
      }
      
      // --- NEW: AUTOMATICALLY LOAD PINNED DATABASES ---
      const pinnedJSON = localStorage.getItem('pinnedSensors');
      const pinnedCollections = pinnedJSON ? JSON.parse(pinnedJSON) : [];
      
      // Create a unique, ordered list. Event's collection is first, followed by pinned.
...
      const windowDuration = Math.max(20, eventDurationSecs + paddingSecs * 2);
      const startTimeWithPadding = new Date(eventStart.getTime() - paddingSecs * 1000);
