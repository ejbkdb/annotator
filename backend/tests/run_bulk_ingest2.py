...
if __name__ == "__main__":
    # --- Argument Parsing ---
    parser = argparse.ArgumentParser(description="Bulk ingest WAV files into QuestDB.")
    parser.add_argument("--folder-path", required=True, help="The full path to the folder containing WAV files.")
    parser.add_argument("--collection-name", required=True, help="The name of the collection to ingest data into.")
    ...
    print(f"Found {len(wav_files)} WAV files to process in '{FOLDER_PATH}' for collection '{COLLECTION_NAME}':")
